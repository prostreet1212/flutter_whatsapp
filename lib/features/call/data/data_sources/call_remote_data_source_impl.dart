...
import 'package:flutter_whatsapp/features/call/data/data_sources/call_remote_data_source.dart';
import 'package:flutter_whatsapp/features/call/domain/entities/call_entity.dart';
...
class CallRemoteDataSourceImpl extends CallRemoteDataSource{
  ...
  Stream<List<CallEntity>> getMyCallHistory(String uid) {
    ...
    return myHistoryCollection.snapshots().map((querySnapshots) => querySnapshots
        .docs.map((e) => CallModel.fromSnapshot(e)).toList());
  }
  ...
  Future<void> saveCallHistory(CallEntity call) async{
    final myHistoryCollection = fireStore.collection(FirebaseCollectionConst.users)
        .doc(call.callerId).collection(FirebaseCollectionConst.callHistory);
    final otherHistoryCollection = fireStore.collection(FirebaseCollectionConst.users)
        .doc(call.receiverId).collection(FirebaseCollectionConst.callHistory);
