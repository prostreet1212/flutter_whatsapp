...
import 'package:flutter_whatsapp/features/call/presentation/pages/pick_up_call_page.dart';
...
import 'package:flutter_whatsapp/features/chat/presentation/widgets/chat_utils.dart';
...
class _SingleChatPageState extends State<SingleChatPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final MessageCubit provider = BlocProvider.of<MessageCubit>(context);
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                  ...
                  children: [
                    Container(
                        ...
                        child: Column(
                         ...
                         //низ виджета текст сообщения (или др.)
                            MessageTypeWidget(
                              message: message,
                              type: messageType,
                            ),
                ...
                //низ виджета дата и галочка о прочтении
                Positioned(
                  bottom: 4,
                  right: 5,
                  child: Row(
